...
public class RecyclerViewDynamicActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        books.add(mBook);
        mBook = new Book();
        mBook.setBookName("Android Developer Guide 2");
        mBook.setAuthor("Leon");
        mBook.setPublishTime(2014);
        books.add(mBook);
        mBook = new Book();
        mBook.setBookName("C++ Developer Guide 2");
        mBook.setAuthor("John");
        mBook.setPublishTime(2015);
        books.add(mBook);
        mBook = new Book();
        mBook.setBookName("Java Developer Guide 2");
        mBook.setAuthor("Marc");
        mBook.setPublishTime(2013);
        books.add(mBook);
        mBook = new Book();
        ...
        books.add(mBook);
        mBook = new Book();
        mBook.setBookName("Swift Developer Guide 2");
        mBook.setAuthor("Stewart");
        mBook.setPublishTime(2009);
        books.add(mBook);
        mBook = new Book();
        mBook.setBookName("PHP Developer Guide 2");
        mBook.setAuthor("Jim");
        mBook.setPublishTime(2008);
        books.add(mBook);
        mBook = new Book();
        mBook.setBookName("Objective-C Developer Guide 2");
        mBook.setAuthor("Robert");
        mBook.setPublishTime(20007);
        books.add(mBook);
        mBook.setBookName("Objective-C Developer Guide 2");
